...
export default function LegacyLayoutPrintRedirectPage() {
  ...
  useEffect(() => {
    async function resolvePrintRoute() {
      if (!layoutId) {
      ...
      navigate(`/editor/project/${data.project_id}/print/${data.id}${location.search}`, { replace: true })
    }

    void resolvePrintRoute()
